...
This phase includes file recognition, TextMate highlighting, embedded C#/CSS scopes, brackets, folding, and snippets where supported by the host. The shared Language Server adds diagnostics plus syntax-tree template/CSS/C# script completion, hover, symbols, definition navigation, and semantic tokens.
