...
The plugin reuses the same grammar files as the VS Code and Visual Studio extensions. The plugin bundles and starts the shared Square Language Server for diagnostics, syntax-tree template/CSS/C# script completion, hover, document symbols, semantic tokens, and component definition navigation.
